        ...
        <div class="stat-grid">
          <div class="stat-card">
            ...
            <div class="stat-content">
              <span class="stat-number" id="stat-admin-count">8</span>
              <span class="stat-subtext">Admin · 2 super admin</span>
            </div>
          </div>
          ...
          <div class="stat-card">
            ...
            <div class="stat-content">
              <span class="stat-number" id="stat-guru-count">64</span>
              <span class="stat-subtext">Guru · 12 wali kelas</span>
            </div>
          </div>
          ...
          <div class="stat-card">
            ...
            <div class="stat-content">
              <span class="stat-number" id="stat-murid-count">1.248</span>
              <span class="stat-subtext">Murid · 36 rombel aktif</span>
            </div>
          </div>
        </div>
